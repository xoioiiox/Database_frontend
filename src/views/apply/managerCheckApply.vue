    ...
    <div>
        ...
        <div>
            ...
            <el-col span="18" class="project_apply_table" style="width:65%">
                <el-table :data="project_applies" border>
                    ...
                    <el-table-column label="审核申请" width="200">
                        <template slot-scope="scope">
                            <el-button @click="passApply(scope.row.student_id, scope.row.project_id)" type="text">通过</el-button>
                            <el-button @click="refuseApply(scope.row.student_id, scope.row.project_id)" type="text">拒绝</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
...
export default {
    ...
    data() {
        return {
            project_applies: [
                {student_id: '1' ,name: '张三', project_id: '1', project_name: '项目一', type: '加入'},
                {student_id: '1' ,name: '张三', project_id: '1', project_name: '项目一', type: '加入'},
                {student_id: '1' ,name: '张三', project_id: '1', project_name: '项目一', type: '加入'},
            ],
            student_info: {
    ...
    methods: {
        ...
        passApply(student_id, project_id) {
            this.axios({
                methods: 'post',
                url: '',
        ...
        refuseApply(student_id, project_id) {
            this.axios({
                methods: 'post',
                url: '',
                data: {student_id, project_id}
